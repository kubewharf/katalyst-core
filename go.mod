...
require (
	...
	github.com/kubewharf/katalyst-api v0.5.10-0.20260202133515-dfeb825266f9
...
replace (
	github.com/kubewharf/katalyst-api => github.com/kubewharf/katalyst-api v0.5.10-0.20260226061123-06bda0587099
