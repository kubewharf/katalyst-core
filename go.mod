...
require (
	...
	github.com/kubewharf/katalyst-api v0.5.5-0.20250612072253-16f7ad2aac9f
...
replace (
	github.com/kubewharf/katalyst-api => github.com/luomingmeng/katalyst-api v0.0.0-20250619082159-68861ffccb6d
