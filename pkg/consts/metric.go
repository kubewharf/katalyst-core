...
const (
	...
	MetricMemKswapdstealRateSystem         = MetricMemKswapdstealSystem + Rate
	MetricMemVmStatPgStealDirectRateSystem = MetricMemVmStatPgStealDirectSystem + Rate
	MetricMemVmStatPgScanKswapdRateSystem  = MetricMemVmStatPgScanKswapdSystem + Rate
	MetricMemVmStatPgScanDirectRateSystem  = MetricMemVmStatPgScanDirectSystem + Rate
