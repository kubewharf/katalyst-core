...
// allocatable can be aggregated resource for multi numa,
// because dedicated_cores with numa_exclusive pod may be allocated to more than one numa under numeric policy.
func mostAllocatedScoreStrategy(requested, allocatable v1.ResourceList, resourceToWeightMap resourceToWeightMap, alignedResource sets.String) int64 {
	var score int64 = 0
