...
type GetAdviceRequest struct {
	...
	WantedFeatureGates   map[string]*FeatureGate              `protobuf:"bytes,2,rep,name=wanted_feature_gates,json=wantedFeatureGates,proto3" json:"wanted_feature_gates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}
...
func (m *GetAdviceRequest) GetWantedFeatureGates() map[string]*FeatureGate {
	if m != nil {
...
type GetAdviceResponse struct {
	PodEntries            map[string]*CalculationEntries `protobuf:"bytes,1,rep,name=pod_entries,json=podEntries,proto3" json:"pod_entries,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ExtraEntries          []*CalculationInfo             `protobuf:"bytes,2,rep,name=extra_entries,json=extraEntries,proto3" json:"extra_entries,omitempty"`
	SupportedFeatureGates map[string]*FeatureGate        `protobuf:"bytes,3,rep,name=supported_feature_gates,json=supportedFeatureGates,proto3" json:"supported_feature_gates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral  struct{}                       `json:"-"`
	XXX_sizecache         int32                          `json:"-"`
}
...
func (m *GetAdviceResponse) GetSupportedFeatureGates() map[string]*FeatureGate {
	if m != nil {
...
type FeatureGate struct {
	...
	MustMutuallySupported bool     `protobuf:"varint,3,opt,name=must_mutually_supported,json=mustMutuallySupported,proto3" json:"must_mutually_supported,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}

func (m *FeatureGate) Reset()      { *m = FeatureGate{} }
func (*FeatureGate) ProtoMessage() {}
func (*FeatureGate) Descriptor() ([]byte, []int) {
	return fileDescriptor_870376c87c2a4145, []int{12}
}
func (m *FeatureGate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FeatureGate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FeatureGate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FeatureGate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FeatureGate.Merge(m, src)
}
func (m *FeatureGate) XXX_Size() int {
	return m.Size()
}
func (m *FeatureGate) XXX_DiscardUnknown() {
	xxx_messageInfo_FeatureGate.DiscardUnknown(m)
}

var xxx_messageInfo_FeatureGate proto.InternalMessageInfo

func (m *FeatureGate) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *FeatureGate) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *FeatureGate) GetMustMutuallySupported() bool {
	if m != nil {
		return m.MustMutuallySupported
	}
	return false
}
...
func (*ListContainersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_870376c87c2a4145, []int{13}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*FeatureGate)(nil), "advisorsvc.GetAdviceRequest.WantedFeatureGatesEntry")
	...
	proto.RegisterMapType((map[string]*FeatureGate)(nil), "advisorsvc.GetAdviceResponse.SupportedFeatureGatesEntry")
	proto.RegisterType((*FeatureGate)(nil), "advisorsvc.FeatureGate")
...
var fileDescriptor_870376c87c2a4145 = []byte{
	...
	,
}
...
func (m *FeatureGate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FeatureGate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FeatureGate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MustMutuallySupported {
		i--
		if m.MustMutuallySupported {
			dAtA[i] = 1
		} else {
	...
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintAdvisorSvc(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintAdvisorSvc(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (this *GetAdviceRequest) String() string {
	...
	mapStringForWantedFeatureGates := "map[string]*FeatureGate{"
...
func (this *GetAdviceResponse) String() string {
	...
	mapStringForSupportedFeatureGates := "map[string]*FeatureGate{"
...
func (this *FeatureGate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&FeatureGate{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
		`MustMutuallySupported:` + fmt.Sprintf("%v", this.MustMutuallySupported) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.WantedFeatureGates == nil {
				m.WantedFeatureGates = make(map[string]*FeatureGate)
			}
			var mapkey string
			var mapvalue *FeatureGate
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.SupportedFeatureGates == nil {
				m.SupportedFeatureGates = make(map[string]*FeatureGate)
			}
			var mapkey string
			var mapvalue *FeatureGate
			for iNdEx < postIndex {
...
func (m *FeatureGate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FeatureGate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FeatureGate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MustMutuallySupported", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MustMutuallySupported = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipAdvisorSvc(dAtA[iNdEx:])
			if err != nil {
