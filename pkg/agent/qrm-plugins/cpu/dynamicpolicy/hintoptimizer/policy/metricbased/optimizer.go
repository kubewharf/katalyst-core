...
func (o *metricBasedHintOptimizer) enableMetricPreferredNUMAAllocation() bool {
	metricPolicyEnabled, _ := strategygroup.IsStrategyEnabledForNode(consts.StrategyNameMetricPreferredNUMAAllocation, false, o.conf)
...
func (o *metricBasedHintOptimizer) getNUMAMetricThresholdNameToValue() (map[string]float64, error) {
	...
	metricThreshold := o.conf.DynamicAgentConfiguration.GetDynamicConfiguration().MetricThreshold
...
func (o *metricBasedHintOptimizer) getNUMAMetricThreshold(thresholdName string, metricThreshold *metricthreshold.MetricThreshold) (float64, error) {
	if metricThreshold == nil {
