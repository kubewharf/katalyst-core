...
func (ci *CalculationInfo) IsSharedNUMABindingPool() bool {
	...
	return len(ci.CalculationResultsByNumas) == 1 && ci.CalculationResultsByNumas[FakedNUMAID] == nil
}
...
func (ce *CalculationEntries) IsPoolEntry() bool {
	...
	return len(ce.Entries) == 1 && ce.Entries[FakedContainerName] != nil
}
...
func (ce *CalculationEntries) IsSharedNUMABindingPoolEntry() bool {
	...
	return len(ce.Entries[FakedContainerName].CalculationResultsByNumas) == 1 &&
		ce.Entries[FakedContainerName].CalculationResultsByNumas[FakedNUMAID] == nil
}
