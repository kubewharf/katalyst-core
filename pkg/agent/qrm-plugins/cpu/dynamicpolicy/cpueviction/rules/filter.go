...
const (
	UpgradingFilterName     = "Upgrading"
	ConsumerFilterName      = "Consumer"
...
var allFilters = map[string]FilterFunc{
	UpgradingFilterName:     UpgradingFilter,
	ConsumerFilterName:      ConsumerFilter,
...
func ConsumerFilter(pod *v1.Pod, params interface{}) bool {
	return false
}
