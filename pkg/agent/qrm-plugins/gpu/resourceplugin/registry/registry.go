...
import (
	...
	"github.com/kubewharf/katalyst-core/pkg/agent/qrm-plugins/gpu/resourceplugin/virtualgpu"
)
...
func init() {
	RegisterResourcePlugin(gpuconsts.GPUMemPluginName, virtualgpu.NewVirtualGPUPlugin)
}
