...
func TestRestrictProvisionControlKnob(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			originControlKnob: map[types.CPUProvisionPolicyName]types.ControlKnob{"p1": {configapi.ControlKnobReclaimedCPUQuota: types.ControlKnobItem{Value: 16}}, "p2": {configapi.ControlKnobReclaimedCPUQuota: types.ControlKnobItem{Value: 10}}},
			wantControlKnob:   map[types.CPUProvisionPolicyName]types.ControlKnob{"p1": {configapi.ControlKnobReclaimedCPUQuota: types.ControlKnobItem{Value: 10}}, "p2": {configapi.ControlKnobReclaimedCPUQuota: types.ControlKnobItem{Value: 10}}},
		},
	}
