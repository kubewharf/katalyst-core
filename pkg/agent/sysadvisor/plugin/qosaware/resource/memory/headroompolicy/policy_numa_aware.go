...
func (p *PolicyNUMAAware) reviseNUMAHeadroomMemory(
	...
	general.InfoS("NUMA memory limit", "numaReclaimMemoryLimit", numaReclaimMemoryLimit, "numaReclaimMemoryUtil", numaReclaimMemoryUtil)
	...
	for numaID, memory := range numaHeadroom {
		...
		*/
		...
		general.InfoS("overSoldRate", "overSoldRate", overSoldRate, "maxOversoldRate", maxOversoldRate, "numaID", numaID)
