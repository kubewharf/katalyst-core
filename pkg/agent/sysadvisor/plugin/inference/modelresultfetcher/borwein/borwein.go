...
type ConvertBorweinContainerInputFunc func(map[string]interface{}) map[string]interface{}

var convertBorweinContainerInputFunc ConvertBorweinContainerInputFunc = nativeConvertBorweinContainerInputFunc

func SetConvertBorweinContainerInputFunc(f ConvertBorweinContainerInputFunc) {
	convertBorweinContainerInputFunc = f
}

func nativeConvertBorweinContainerInputFunc(containerInput map[string]interface{}) map[string]interface{} {
...
func (bmrf *BorweinModelResultFetcher) getInferenceRequestForPods(requestContainers []*types.ContainerInfo, metaReader metacache.MetaReader,
	...
	podInfo = convertBorweinContainerInputFunc(podInfo)
