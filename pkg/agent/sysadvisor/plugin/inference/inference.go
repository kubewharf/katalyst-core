...
import (
	...
	borweininput "github.com/kubewharf/katalyst-core/pkg/agent/sysadvisor/plugin/inference/modelinputfetcher/borwein"
...
func init() {
	modelinputfetcher.RegisterModelInputFetcherInitFunc(borweininput.BorweinModelInputFetcherName,
		borweininput.NewBorweinModelInputFetcher)
