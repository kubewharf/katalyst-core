...
import (
	...
	"github.com/kubewharf/katalyst-core/pkg/metaserver/agent/metric/provisioner/resctrl"
...
func init() {
	...
	RegisterProvisioners(metaserver.MetricProvisionerResctrl, resctrl.NewResctrlMetricsProvisioner)
}
