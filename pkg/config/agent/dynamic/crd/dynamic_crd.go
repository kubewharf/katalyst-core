...
type DynamicConfigCRD struct {
	...
	UserWatermarkConfiguration               *v1alpha1.UserWatermarkConfiguration
}
...
var (
	...
	// UserWatermarkConfigurationGVR is the group version resource for UserWatermarkConfiguration
	UserWatermarkConfigurationGVR = metav1.GroupVersionResource(v1alpha1.SchemeGroupVersion.WithResource(v1alpha1.ResourceNameUserWatermarkConfigurations))
)
