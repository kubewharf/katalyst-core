					...
					Metric: v2.MetricIdentifier{
						...
						Selector: &metav1.LabelSelector{
							MatchLabels: map[string]string{
								...
								katalystmetric.MetricSelectorKeySPDContainerName: fmt.Sprintf("%s-%s", IHPAControllerName, resourceportrait.ResourcePortraitMethodPredict),
						...
						Items: []v1beta1.PodMetrics{
							{
								...
								Containers: []v1beta1.ContainerMetrics{
									{
										Name: fmt.Sprintf("%s-%s", IHPAControllerName, resourceportrait.ResourcePortraitMethodPredict),
