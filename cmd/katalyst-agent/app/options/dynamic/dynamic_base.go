...
import (
	...
	"github.com/kubewharf/katalyst-core/cmd/katalyst-agent/app/options/dynamic/power"
...
func NewDynamicOptions() *DynamicOptions {
	return &DynamicOptions{
		...
		PowerOptions:                       power.NewPowerOptions(),
	}
}
...
func (o *DynamicOptions) ApplyTo(c *dynamic.Configuration) error {
	...
	errList = append(errList, o.PowerOptions.ApplyTo(c.PowerManagementConfiguration))
