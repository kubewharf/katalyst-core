...
func (o *IRQLoadBalanceTuningThresholdOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.IntVar(&o.CPUUtilThreshold, "cpu-util-threshold", o.CPUUtilThreshold, "irq core cpu util threshold, which will trigger irq cores load balance, generally this value should greater-equal IrqCoresExpectedCpuUtil")
	fs.IntVar(&o.CPUUtilGapThreshold, "cpu-util-gap-threshold", o.CPUUtilGapThreshold, "threshold of cpu util gap between source core and dest core of irq affinity changing")
}

func (o *IRQLoadBalanceTuningThresholdOptions) ApplyTo(c *loadbalance.IRQLoadBalanceTuningThresholds) error {
	c.CPUUtilThreshold = o.CPUUtilThreshold
	c.CPUUtilGapThreshold = o.CPUUtilGapThreshold
