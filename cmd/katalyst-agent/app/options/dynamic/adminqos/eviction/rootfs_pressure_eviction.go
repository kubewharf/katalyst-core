...
func (o *RootfsPressureEvictionOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.StringSliceVar(&o.RootfsOveruseEvictionSupportedQoSLevels, "eviction-rootfs-overuse-supported-qos-levels", o.RootfsOveruseEvictionSupportedQoSLevels, "the supported qos levels for rootfs overuse eviction")
	...
	fs.IntVar(&o.RootfsOveruseEvictionCount, "eviction-rootfs-overuse-count", o.RootfsOveruseEvictionCount, "the count of rootfs overuse eviction")
	fs.StringSliceVar(&o.SharedQoSNamespaceFilter, "eviction-rootfs-overuse-shared-qos-namespace-filter", o.SharedQoSNamespaceFilter, "the namespace filter for shared qos pods")
}
